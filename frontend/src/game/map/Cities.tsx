...
const CityCircle = styled(motion.circle)`
  fill: #f39b37;
  stroke: #000;
  stroke-miterlimit: 10;
`;

const CityText = styled(motion.text)`
  font-size: 27px;
